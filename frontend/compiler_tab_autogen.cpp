...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_add_expr = 48,                  /* add_expr  */
  YYSYMBOL_addop = 49,                     /* addop  */
  YYSYMBOL_term = 50,                      /* term  */
  YYSYMBOL_mulop = 51,                     /* mulop  */
...
{
       0,    47,    47,    51,    55,    62,    68,    72,    76,    82,
      85,    92,    95,    99,   105,   108,   112,   115,   119,   123,
     126,   130,   136,   140,   147,   153,   157,   160,   163,   163,
     166,   169,   173,   180,   180,   187,   190,   196,   197,   198,
     199,   200,   201,   205,   208,   214,   215,   219,   222,   228,
     229,   233,   236,   239,   242,   245,   248,   254,   257,   261
};
#endif
...
static const char *const yytname[] =
{
  ...
  "WHILE", "RETURN", "BREAK", "NUM", "TRUE", "FALSE", "ID", "LE", "GE",
  "EQ", "NE", "GT", "LT", "'('", "')'", "'{'", "'}'", "'*'", "'/'", "'%'",
  "'+'", "'-'", "'='", "';'", "','", "'<'", "'>'", "$accept", "program",
  "function", "params", "type", "body", "decl_list", "decl", "stmts",
  "stmt", "$@1", "block", "$@2", "expr", "relop", "add_expr", "addop",
  "term", "mulop", "factor", "args", YY_NULLPTR
};
...
{
       1,   -75,     5,   -75,    12,   -75,   -75,     3,     1,    10,
      26,    22,     1,   -75,    -1,   -75,    43,    51,    66,     7,
     -75,   -75,    24,    63,    52,    65,    71,    67,    69,   -75,
     -75,   -75,    27,   -75,   -75,    71,   -75,   -75,    71,   -75,
     -75,    71,    71,   -75,   -75,   -75,    75,    71,    70,    59,
      -7,   -75,   -75,    71,    58,   -75,   -75,    28,    39,    78,
      80,    71,    81,   -75,   -75,   -75,   -75,   -75,   -75,   -75,
     -75,   -75,    71,    71,   -75,   -75,    71,    73,    38,   -75,
     -75,   -75,   -75,    74,   -75,   -75,    21,   -75,    62,    -7,
     -75,   -75,   -75,    98,    74,   -75,    71,    74,   -75,   -75,
     -75
};
...
{
       4,     9,     0,     3,     0,     1,     2,     0,     8,     0,
       0,     0,     0,     6,    13,     5,     0,     0,     0,    24,
      11,     7,     0,     0,     0,     0,     0,     0,     0,    33,
      32,    12,     0,    22,    31,     0,    18,    19,     0,    14,
      15,     0,     0,    53,    54,    55,    52,     0,     0,    36,
      44,    48,    30,     0,    24,    10,    23,     0,     0,     0,
       0,    59,     0,    26,    37,    40,    41,    42,    39,    38,
      45,    46,     0,     0,    49,    50,     0,     0,     0,    20,
      21,    16,    17,     0,    28,    57,     0,    51,    35,    43,
      47,    25,    34,     0,     0,    56,     0,     0,    29,    58,
      27
};
...
{
     -75,   -75,   102,   -75,    13,   -75,   -75,    86,    53,   -31,
     -75,   -74,   -75,   -35,   -75,    34,   -75,    35,   -75,    33,
     -75
};
...
{
       0,     2,     3,     9,     4,    15,    19,    20,    32,    33,
      94,    34,    54,    48,    72,    49,    73,    50,    76,    51,
      86
};
...
{
      57,    56,     1,    58,     1,     5,    59,    60,     1,    93,
       1,    24,    62,    25,    26,    27,    74,    75,    77,    28,
      98,    10,     8,   100,     7,    16,    85,    18,    29,    17,
      11,    24,    18,    25,    26,    27,    30,    17,    13,    28,
      12,    95,    24,    14,    25,    26,    27,    56,    29,    55,
      28,    96,    35,    36,    37,    21,    30,    79,    80,    29,
      92,    99,    24,    22,    25,    26,    27,    30,    81,    82,
      28,    41,    64,    65,    66,    67,    68,    69,    23,    29,
      43,    44,    45,    46,    42,    70,    71,    30,    70,    71,
      47,    38,    39,    40,    61,    29,    52,    53,    83,    63,
      84,    87,    91,    97,     6,    31,    88,    78,    89,    90
};

static const yytype_int8 yycheck[] =
{
      35,    32,     3,    38,     3,     0,    41,    42,     3,    83,
       3,     4,    47,     6,     7,     8,    23,    24,    53,    12,
      94,     8,    19,    97,    12,    12,    61,    14,    21,    30,
      20,     4,    19,     6,     7,     8,    29,    30,    12,    12,
      30,    20,     4,    21,     6,     7,     8,    78,    21,    22,
      12,    30,    28,    29,    30,    12,    29,    29,    30,    21,
      22,    96,     4,    12,     6,     7,     8,    29,    29,    30,
      12,    19,    13,    14,    15,    16,    17,    18,    12,    21,
       9,    10,    11,    12,    19,    26,    27,    29,    26,    27,
      19,    28,    29,    30,    19,    21,    29,    28,    20,    29,
      20,    20,    29,     5,     2,    19,    72,    54,    73,    76
};
...
{
       0,     3,    34,    35,    37,     0,    35,    12,    19,    36,
      37,    20,    30,    12,    21,    38,    37,    30,    37,    39,
      40,    12,    12,    12,     4,     6,     7,     8,    12,    21,
      29,    40,    41,    42,    44,    28,    29,    30,    28,    29,
      30,    19,    19,     9,    10,    11,    12,    19,    46,    48,
      50,    52,    29,    28,    45,    22,    42,    46,    46,    46,
      46,    19,    46,    29,    13,    14,    15,    16,    17,    18,
      26,    27,    47,    49,    23,    24,    51,    46,    41,    29,
      30,    29,    30,    20,    20,    46,    53,    20,    48,    50,
      52,    29,    22,    44,    43,    20,    30,     5,    44,    46,
      44
};
...
static const yytype_int8 yyr1[] =
{
      ...
      40,    40,    41,    41,    41,    42,    42,    42,    43,    42,
      42,    42,    42,    45,    44,    46,    46,    47,    47,    47,
...
yy_symbol_value_print (FILE *yyo,
                       yysymbol_kind_t yykind, YYSTYPE const * const yyvaluep, YYLTYPE const * const yylocationp, ParseContext* context)
{
  FILE *yyoutput = yyo;
  YY_USE (yyoutput);
  YY_USE (yylocationp);
...
yy_reduce_print (yy_state_t *yyssp, YYSTYPE *yyvsp, YYLTYPE *yylsp,
                 int yyrule, ParseContext* context)
{
...
yydestruct (const char *yymsg,
            yysymbol_kind_t yykind, YYSTYPE *yyvaluep, YYLTYPE *yylocationp, ParseContext* context)
{
  YY_USE (yyvaluep);
  YY_USE (yylocationp);
  YY_USE (context);
